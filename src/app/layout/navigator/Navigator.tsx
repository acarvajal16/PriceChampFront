    ...
    return (
        <div className="w-full h-full bg-primary-color flex">
            <div className="flex justify-center items-center p-4">
                <img src={Logo} className="m-1.5 pl-3 w-32 h-32" alt='mySvgImage' />
            </div>
            {
                user ? (
                    <>
                    ...
                    <>
                        <div className="w-full flex justify-between items-center p-4 text-white font-bold">
                            ...
                            <div className="flex items-center justify-center mr-2 md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                                <button
                                    type="button"
                                    className=" flex text-nowrap text-xs  bg-white text-black hover:bg-black hover:text-white focus:ring-2 focus:outline-none focus:ring-white font-medium rounded-lg mx-2  px-4 py-1 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                >
                                    Iniciar Sesión
                                </button>
                                <button
